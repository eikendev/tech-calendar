...
DEFAULT_LLM_MODEL: str = "openai-responses:gpt-5"
...
DEFAULT_EVENTS_RELCALID: str = "tech.calendar.events"
DEFAULT_EVENTS_CALENDAR_NAME: str = "Tech Event Calendar"
DEFAULT_EVENTS_CALENDAR_DESCRIPTION: str = "Consolidated annual technology events, regenerated automatically."
DEFAULT_EVENTS_ICS_PATH: Path = Path("events.ics")
DEFAULT_EVENTS_RETENTION_YEARS: int = 5
